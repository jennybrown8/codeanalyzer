...
montage -verbose -font Arial -pointsize 10 -background "#FFFFFF" -fill "gray" -define png:size=200x80 -geometry "200x80" -tile "40x60" -auto-orient ../target/images/*.png ~/contact.png
